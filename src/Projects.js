        ...
        <div id={"projects"}>
            ...
            <Container>
                <div id={"proj"}>
                    ...
                    <p>-Developing a prototype for underwater acoustic communication<br/>
                        ...
                        -Wrote automated testing code to examine accuracy of transmission.
                    </p>
                </div>
                <div id={"proj"}>
                    ...
                    <p>-We are taking an existing application and migrating the data from MongoDB to a MySQL database.<br/>
                        ...
                        -Adding privileges hierarchy that allows certain users add new admin and approve requests.
                    </p>
                </div>
            </Container>
            ...
            <Container>
                <div id={"proj"}>
                    ...
                    <img id="dataViz" src="/dataViz.png" alt="Data Visualization Screenshot"/>
                </div>
                <div id={"proj"}>
